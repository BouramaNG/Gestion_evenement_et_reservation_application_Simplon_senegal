			...
			<table class="table table-striped table-hover">
                ...
                @foreach($events as $event)		
                    ...
                    <td scope="row"><img src="{{ asset('public/image/' . $event->photo) }}" alt="Event Image" style="max-width: 50px;"></th>
						<td>
                        <a href="{{route('update_event',['id'=>$event->id])}}" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Supprimer</span></a>
							<a href="{{route('update_event',['id'=>$event->id])}}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
							<a href="{{ route('delete_event', ['id' => $event->id]) }}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>
					</tr> 
                    @endforeach
				</tbody>
