    ...
    <div class="topbar d-flex align-items-center">
                ...
                <ul class="navbar-nav align-items-center">
                    ...
                    <li class="nav-item dropdown dropdown-large">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="javascript:;">
                                <div class="text-center msg-footer">Tout les notifications</div>
                            </a>
                        </div>
                    </li>
                    <li class="nav-item dropdown dropdown-large">
        ...
        <p class="designattion mb-0"></p>
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <!-- <li><a class="dropdown-item" href="i class="bx bx-cog"></i><span>Modifier Mot De Passe</span></a> -->
                    </li>
                    ...
                    <li><a class="dropdown-item" href=""><i class='bx bx-log-out-circle'></i><span>Deconnexion</span></a>
                    </li>
                </ul>
            </div>
        </nav>
